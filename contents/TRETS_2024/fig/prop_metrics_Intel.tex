...
\centering
\vspace{-12px}
\subfloat[\textit{First Index} metric]{\includegraphics[width= 0.75\linewidth]{img/intel_first.png}\label{fig:prop-first-intel}}\\
\vspace{-12px}
\subfloat[\textit{Last Index} metric]{\includegraphics[width= 0.75\linewidth]{img/intel_last.png}\label{fig:prop-last-intel}}\\
\vspace{-12px}
\subfloat[\textit{Binary Hamming Distance} metric]{\includegraphics[width= 0.75\linewidth]{img/intel_ham.png}\label{fig:prop-pop-intel}}
