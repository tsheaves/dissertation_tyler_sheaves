...
\input{contents/ICCAD_2026/figs/optimal_burst_seq_combined.tex}
...
number of parity bits. Figures~\ref{fig:opt-burst4m}
and~\ref{fig:opt-burst8m} show the entropy efficiency measured across
