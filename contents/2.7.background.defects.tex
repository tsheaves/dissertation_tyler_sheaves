...
progressively modifies the filament morphology~\cite{chen2011physical,
	wang2015reramwearout, zhang2016mellowwrite}. Over time, these changes
increase the number of PV iterations required to complete a transition
and shift the write latency distribution toward longer completions. The
endurance of an OxRAM device is typically specified as the number of
SET/RESET cycles before the RBER exceeds a target
threshold~\cite{hayakawa2017resolving, fukuyama2019comprehensive}.
...
mitigated in program-verify schemes by introducing a delay between the
